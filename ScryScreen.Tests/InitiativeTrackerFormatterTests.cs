...
public class InitiativeTrackerFormatterTests
{
    ...
    {
        var a = new InitiativeEntry(Guid.NewGuid(), "A", 10, IsHidden: true);
        var b = new InitiativeEntry(Guid.NewGuid(), "B", 5, IsHidden: false);
    ...
    public void MaxEntries_ShowsEllipsisAndCount()
    {
        ...
        {
            entries[i] = new InitiativeEntry(Guid.NewGuid(), $"E{i}", 10 - i);
        }
